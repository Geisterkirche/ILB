...
public class NodeWDS {
	...
	public double theta;
	public double rho;
	public char[] modyfyer2 = new char[2];// V
					// N
	...
	public void calculateIdDM(String s){
		...
		try{
			if(idDM.charAt(2)!=' ' && idDM.charAt(1)!=' '){
				idDM=idDM.substring(0,3)+" "+idDM.substring(3,idDM.length());
			}
		}catch(Exception e){
		}
	}
	...
	public void calculateNameOfObserver(String s){
		nameOfObserver=s.substring(10, 23);
