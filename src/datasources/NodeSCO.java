...
//		 }
	...
	public void calculateIdHIP(String s){
		...
		try{
			if(
				idHIP.charAt(idHIP.length()-1)!='0' &&
				idHIP.charAt(idHIP.length()-1)!='1' &&
				idHIP.charAt(idHIP.length()-1)!='2' &&
				idHIP.charAt(idHIP.length()-1)!='3' &&
				idHIP.charAt(idHIP.length()-1)!='4' &&
				idHIP.charAt(idHIP.length()-1)!='5' &&
				idHIP.charAt(idHIP.length()-1)!='6' &&
				idHIP.charAt(idHIP.length()-1)!='7' &&
				idHIP.charAt(idHIP.length()-1)!='8' &&
				idHIP.charAt(idHIP.length()-1)!='9'){
				idHIP=idHIP.substring(0,idHIP.length()-1);
			}			
		}catch(Exception e){
		}	
	}
	...
	public void calculateIdHD(String s){
		...
		try{
			if(
				idHD.charAt(idHD.length()-1)!='0' &&
				idHD.charAt(idHD.length()-1)!='1' &&
				idHD.charAt(idHD.length()-1)!='2' &&
				idHD.charAt(idHD.length()-1)!='3' &&
				idHD.charAt(idHD.length()-1)!='4' &&
				idHD.charAt(idHD.length()-1)!='5' &&
				idHD.charAt(idHD.length()-1)!='6' &&
				idHD.charAt(idHD.length()-1)!='7' &&
				idHD.charAt(idHD.length()-1)!='8' &&
				idHD.charAt(idHD.length()-1)!='9'){
	...
	public void calculatePair(String s){
		...
		try{
			nameOfObserver=clearify(nameOfObserver);
			if(nameOfObserver.charAt(0)==' '){
				nameOfObserver="";
			}else{
				if(nameOfObserver.charAt(1)==' '){
					nameOfObserver="";
				}else{
					if(nameOfObserver.charAt(2)==' '){
						nameOfObserver="";
					}
				}
			}
