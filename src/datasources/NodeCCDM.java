...
public class NodeCCDM {
	...
	/*public int coord_I1_1=0;
	public int coord_I1_2=0;*/
	public int coord_I2_1=0;
	public int coord_I2_2=0;
	//public int coord_F1_1=0;
	//public int coord_F1_2=0;
	...
	public NodeCCDM(String s){
		...
		if(s.charAt(12)=='A'){
			...
			if(s.charAt(27)!=' '){
				...
				//System.out.println(s.substring(30,35)+" "+Integer.parseInt(s.substring(30,35)));
				//System.out.println(s.charAt(36)+" "+(int)Integer.parseInt(""+s.charAt(36)));
			}
		}else if(s.charAt(11)==' '){
